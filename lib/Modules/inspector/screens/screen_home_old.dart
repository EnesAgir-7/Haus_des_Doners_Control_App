...
import '../providers/provider_panel_old.dart';
import '../providers/provider_route.dart';
import '../providers/provider_tasks.dart';
import 'screen_submit_report.dart';

class ScreenHomeOld extends StatefulWidget {
  const ScreenHomeOld({super.key});

  @override
  State<ScreenHomeOld> createState() => _ScreenHomeOldState();
}

class _ScreenHomeOldState extends State<ScreenHomeOld> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<ProviderPanelOld>().initialize();
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: RefreshIndicator(
          onRefresh: () async {
            await context.read<ProviderPanelOld>().refresh();
...
class PerformanceSection extends StatelessWidget {
  final ProviderPanelOld provider;
