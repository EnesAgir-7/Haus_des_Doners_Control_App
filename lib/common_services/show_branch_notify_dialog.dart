...
/// Global method to show a notification dialog for branch
Future<void> showBranchNotifyDialog({
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.all(20),
                child: isLoggedOut
                    ? _buildLoggedOutContent(branchName)
                      ...
                      Material(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            ...
                            final result = await NotificationHelper.instance
                            ...
                            if (result['success'] == true) {
                              showSnakBarr(
                                ...
                                LocaleKeys.notificationSentMessage.tr(
                                  namedArgs: {'inspectorName': branchName},
                                ),
                              );
                            } else {
                              showSnakBarr(
...
Widget _buildLoggedOutContent(String branchName) {
  return Column(
    mainAxisSize: MainAxisSize.min,
