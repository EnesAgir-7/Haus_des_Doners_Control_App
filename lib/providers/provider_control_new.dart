...
//   Future<void> initializeOneDrive() async {
//     try {
//       await _oneDriveService.initialize();
//       // Check if user is already logged in
//       if (!_oneDriveService.isLoggedIn) {
//         final success = await _oneDriveService.login();
//         if (!success) {
//           _errorMessage = 'Failed to connect to OneDrive';
//           notifyListeners();
//         }
//       }
//     } catch (e) {
//       print('OneDrive initialization error: $e');
//     }
//   }
...
//       // Ensure OneDrive is connected
//       if (!_oneDriveService.isLoggedIn) {
//         final connected = await _oneDriveService.login();
//         if (!connected) {
//           throw Exception('Failed to connect to OneDrive');
//         }
//       }
...
//       // Generate PDF report (assuming you have this method)
...
//             // Get download URLs from OneDrive uploads
...
//         pdfReportUrl: pdfUploadResult['downloadUrl'], // Add PDF URL
//         pdfReportWebUrl: pdfUploadResult['webUrl'], // Add web viewing URL
//         createdAt: now,
//         updatedAt: now,
//       );
